...
run;
	/*Now we can see the format of DOB again*/ 

/*how old are they today?*/
data familydutton_3;
SET familydutton_2;
	date0 = today();   			/*create a new column of today's date*/
	date1 = mdy(1, 10, 2024); 	 /*similar to above*/
	/*  format date0 date1 mmddyy10.;  */ /*format the "today" variables so they are readable */
	num_of_years = intck("year",DOB, date0);  /*calculate the difference in "years" between the two dates */
run;
