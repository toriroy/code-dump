...
Cholera_simulate_directtransmission <- function(S0 = 1e3, I0 = 1, tmax = 120, scenario = 1, 
                                                bd = 0.01, bf = 0, A = 1, m = 0, n = 0, n_c = 0.001, g = 0.1, w = 0,
                                                k = 10^5, epsilon= 10, delta= 1/41)
{
  ...
  pars=c(tmax = tmax, bd = bd, bf = bf, A = A, m = m, n = n, n_c = n_c, g = g, w = w, 
         k = k, epsilon = epsilon, delta=delta, scenario = scenario); 
