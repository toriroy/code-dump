...
/*categorical cholcat*/
proc logistic data=framcat desc;
class cholcat (ref='1') angina (ref='0')/param=ref; 
model angina = cholcat glucose;
run;
/*glucose p-value=0.0327*/
/*test in model with multiple cholesterol levels*/
proc logistic data=framcat desc;
class cholcat (ref='1') angina (ref='0') sex (ref='2') bmibinary (ref='0') agebinary (ref='0') educbinary (ref='0')/param=ref; 
model angina = cholcat agebinary sex bmibinary educbinary glucose cholcat*educbinary;
run;
/*glucose p-value=0.1703*/
proc logistic data=framcat desc;
class cholcatbinary (ref='0') angina (ref='0') sex (ref='2') bmibinary (ref='0') agebinary (ref='0') educbinary (ref='0')/param=ref; 
model angina = cholcatbinary glucose agebinary sex bmibinary educbinary cholcatbinary*educbinary;
run;
/*glucose p-value=0.1570*/
/*what about original cholesterol variable?*/
proc logistic data=framcat desc;
class  angina (ref='0') sex (ref='2') bmibinary (ref='0') agebinary (ref='0') educbinary (ref='0')/param=ref; 
model angina = totchol glucose agebinary sex bmibinary educbinary totchol*educbinary;
run;
/*glucose p-value=0.2995

what about diabetes instead of glucose?*/
proc logistic data=framcat desc;
class  angina (ref='0') diabetes (ref='0') sex (ref='2') bmibinary (ref='0') agebinary (ref='0') educbinary (ref='0')/param=ref; 
model angina = totchol diabetes agebinary sex bmibinary educbinary totchol*educbinary;
run;
/*diabetes p-value= 0.0924*/
/*categorical cholesterol level and diabetes*/

proc logistic data=framcat desc;
class cholcat (ref='1') cholcatbinary (ref='0') angina (ref='0') diabetes (ref='0') sex (ref='2') bmibinary (ref='0') agebinary (ref='0') educbinary (ref='0')/param=ref; 
model angina = cholcat diabetes agebinary sex bmibinary educbinary cholcatbinary*educbinary;
run;
/*p=value for diabetes = 0.0529
