...
if Age GE 32 and Age LE 42  then agecat = '0'; /*32-42*/
if Age GE 43 and Age LE 53 then agecat = '1'; /*43-53*/
...
if educ GT 2 then educbinary ='0'; /*Some college, vocational school and 4 year degree +*/
run;
...
proc logistic data=framcat descending;
class cholcatbinary (ref='1') angina (ref='0') educ (ref='2') bmibinary (ref='0')/param=ref;
model angina = cholcatbinary;
run;
proc logistic data=framcat descending;
class cholcatbinary (ref='1') angina (ref='0') diabetes (ref='0') educ (ref='2') bmibinary (ref='0')/param=ref;
model angina = cholcatbinary diabetes educ sex bmibinary educ*cholcatbinary sex*cholcatbinary bmibinary*cholcatbinary;
run;
/*remove sex interaction term p=0.62*/
proc logistic data=framcat descending;
class cholcatbinary (ref='1') angina (ref='0') diabetes (ref='0') educ (ref='2') bmibinary (ref='0')/param=ref;
model angina = cholcatbinary diabetes educ sex bmibinary educ*cholcatbinary bmibinary*cholcatbinary;
run;
/*remove bmi interaction term p=0.5468*/
proc logistic data=framcat descending;
class cholcatbinary (ref='1') angina (ref='0') diabetes (ref='0') educ (ref='2') bmibinary (ref='0')/param=ref;
model angina = cholcatbinary diabetes educ sex bmibinary educ*cholcatbinary ;
run;
/*change education to binary and try again*/
proc logistic data=framcat descending;
class educbinary (ref='2') cholcatbinary (ref='1') diabetes (ref='0') angina (ref='0')  bmibinary (ref='0')/param=ref;
model angina = cholcatbinary diabetes educbinary sex bmibinary educbinary*cholcatbinary ;
run;
proc logistic data=framcat descending;
class educbinary (ref='2') cholcatbinary (ref='1') angina (ref='0')  bmibinary (ref='0') agebinary (ref='0')/param=ref;
model angina = cholcatbinary diabetes educbinary sex agebinary bmibinary educbinary*cholcatbinary cholcatbinary*agebinary/corrb;
run;
/*remove age interaction p=0.2243*/

proc logistic data=framcat descending;
class educbinary (ref='2') cholcatbinary (ref='1') diabetes (ref='0') angina (ref='0')  bmibinary (ref='0') agebinary (ref='0')/param=ref;
model angina = cholcatbinary educbinary sex agebinary bmibinary educbinary*cholcatbinary /corrb;
run;
...
proc logistic data=framcat descending;
class educbinary (ref='2') cholcatbinary (ref='1') angina (ref='0')  bmibinary (ref='0') agebinary (ref='0')/param=ref;
model angina = cholcatbinary sex agebinary bmibinary educbinary*cholcatbinary /corrb;
run;
...
proc univariate data=fram noprint;
qqplot bmi age /normal (mu=est sigma=est color=red l=1);
run;

proc logistic data=fram outmodel=model_results;
    model angina(event='1') = age bmi totchol / cl;
output out=predicted_values p=prob_logit;
run;
proc sgplot data=predicted_values;
    scatter x=age y=prob_logit / markerattrs=(symbol=circlefilled);
    scatter x=bmi y=prob_logit / markerattrs=(symbol=circlefilled);
    scatter x=totchol y=prob_logit / markerattrs=(symbol=circlefilled);
run;
proc sgplot data=predicted_values;
title 'age';
scatter x=age y=prob_logit / markerattrs=(symbol=circlefilled);
